...
async function transferWithRetry(tokenAddress, amount) {
  ...
  while (attempt < maxRetries) {
    ...
    try {
      ...
      unsignedTx.gasLimit = ethers.BigNumber.from(100000); // 🔹 ใช้ manual gasLimit แก้ estimateGas fail
      ...
      // 🔹 เคลียร์ tokenProcessing หลังส่งสำเร็จ
      tokenProcessing.set(tokenAddress, false);
